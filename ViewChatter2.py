...
if st.button("Start Chat"):
    ...
    attachment = st.file_uploader("Attach a file (optional)", type=["png", "jpg", "jpeg", "gif", "pdf", "txt"],
                                  key="chat_file")

    if st.button("Send"):
        if user_input or attachment:
            msg = {"role": "user", "message": user_input}
            if attachment:
    ...
    for msg in st.session_state.messages:
        ...
        st.markdown(f"**You:** {text} {attachment_info}")
